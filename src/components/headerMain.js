        ...
        <div className={`${Styles.w3Top}`} desc="Navbar (sit on top)" >
            ...
            <div className={`${Styles.w3Left} `} style={{paddingLeft:'20px',paddingBottom:'0px'}} >
               {this.props.logo.map(({node})=>(
                ...
                <div className={`${Styles.w3DropdownHover} ${Styles.w3HideSmall}`}>
                ...
                <a href="#4" className={`${Styles.w3BarItem} ${Styles.w3Button} ${Styles.w3Right} ${Styles.w3HideLarge} ${Styles.w3HideMedium}`} onClick={()=>this.w3Open()} desc="Hide right-floated links on small screens">
                    <i className="fa fa-bars">m</i>
                </a>
            </div>
        </div>


        <nav className={`${Styles.w3Sidebar} ${Styles.w3BarBlock} ${Styles.w3Black} ${Styles.w3Card} ${Styles.w3AnimateLeft} ${Styles.w3HideMedium} ${Styles.w3HideLarge}`} style={{display:'none'}} id="mySidebar">
