    ...
    render(){
        ...
        <div className={`${Styles.w3Top}`} desc="Navbar (sit on top)" >
            ...
            <div className={`${Styles.w3Left} `} style={{paddingLeft:'20px',paddingBottom:'0px'}} >
               ...
               <strong> <center className={`${Styles.w3Right} `} style={{fontSize:'25px',textAlign:'center', color:'#00843E'}}>&nbsp;Pan-Africa</center></strong>
            </div>
                ...
                <a href="#4" className={`${Styles.w3BarItem} ${Styles.w3Button} ${Styles.w3Right} ${Styles.w3HideLarge} `} onClick={()=>this.w3Open()} style={{paddingRight:'50px'}}> 
